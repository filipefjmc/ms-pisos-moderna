...
>
  <div className="w-12 h-12 rounded-lg flex items-center justify-center border-2 border-white/20 bg-green-500 hover:bg-green-600 transition-colors duration-200 shadow-lg">
